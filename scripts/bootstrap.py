...
def main():
    ...
    info={**previous_info,'product':'codex-token-saver','home':str(root),'codex_home':str(args.codex_home.resolve()),'path_added':previous_info.get('path_added',False) or not args.no_path,'uninstalled':False,'version':'0.1.0-beta.3'}
